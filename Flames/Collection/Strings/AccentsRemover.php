...
namespace Flames\Collection\Strings;
...
final class AccentsRemover
{
    ...
    public static function latin(string $str): string
    {
        static $in   = null;
        static $dIn  = null;
        static $dOut = ['OE', 'oe', 'AE', 'DH', 'TH', 'ss', 'ae', 'dh', 'th'];
        ...
        return str_replace($dIn, $dOut, strtr($str, $in, 'EfSZszYcYuAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy'));
    }
}
